...
export class SectionComponent {
  cards: Card[] = [
    ...
    {
      img: '../assets/icons/route.png',
      title: 'Personalized Routes',
      details: `Break free from the ordinary and discover new frontiers by designing a personalized air route that ventures into unexplored territories.`,
    },
  ];
}
